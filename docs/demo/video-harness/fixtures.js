...
const appointments = [
  { id: 9001, patient_id: 101, provider_id: 2, start_time: at(0, 9, 0), end_time: at(0, 9, 30), duration_minutes: 30, appointment_type: 'Follow-up', status: 'scheduled', location: 'Room 2', reason: 'Diabetes follow-up' },
  { id: 9002, patient_id: 102, provider_id: 2, start_time: at(0, 10, 0), end_time: at(0, 10, 45), duration_minutes: 45, appointment_type: 'Annual physical', status: 'scheduled', location: 'Room 2', reason: 'Annual physical' },
  { id: 9003, patient_id: 103, provider_id: 3, start_time: at(0, 11, 0), end_time: at(0, 11, 30), duration_minutes: 30, appointment_type: 'Telehealth consult', status: 'scheduled', location: 'Telehealth', reason: 'Medication review' },
  { id: 9004, patient_id: 104, provider_id: 2, start_time: at(0, 14, 0), end_time: at(0, 14, 20), duration_minutes: 20, appointment_type: 'Medication check', status: 'scheduled', location: 'Room 1', reason: 'BP recheck' },
  { id: 9005, patient_id: 105, provider_id: 3, start_time: at(1, 9, 30), end_time: at(1, 10, 30), duration_minutes: 60, appointment_type: 'New patient visit', status: 'scheduled', location: 'Room 3', reason: 'New patient intake' },
  { id: 9006, patient_id: 101, provider_id: 2, start_time: at(2, 15, 30), end_time: at(2, 16, 0), duration_minutes: 30, appointment_type: 'Telehealth consult', status: 'scheduled', location: 'Telehealth', reason: 'Lab results review' },
  { id: 9007, patient_id: 102, provider_id: 3, start_time: at(3, 10, 0), end_time: at(3, 10, 30), duration_minutes: 30, appointment_type: 'Follow-up', status: 'scheduled', location: 'Room 1', reason: 'Follow-up' },
  { id: 9008, patient_id: 103, provider_id: 2, start_time: at(-2, 10, 0), end_time: at(-2, 10, 30), duration_minutes: 30, appointment_type: 'Follow-up', status: 'completed', location: 'Room 2', reason: 'Follow-up' },
  { id: 9009, patient_id: 104, provider_id: 2, start_time: at(-5, 11, 0), end_time: at(-5, 11, 45), duration_minutes: 45, appointment_type: 'Annual physical', status: 'completed', location: 'Room 2', reason: 'Annual physical' },
];
