...
export const planFeatures = {
  starter: ['practiceManagement', 'providerManagement', 'rcm', 'accounts', 'inventory', 'patientPortal', 'clinicalServices', 'formManagement'],
  professional: ['practiceManagement', 'providerManagement', 'ehr', 'telehealth', 'rcm', 'accounts', 'inventory', 'crm', 'patientPortal', 'clinicalServices', 'offerings', 'reports', 'formManagement'],
  enterprise: ['practiceManagement', 'providerManagement', 'ehr', 'telehealth', 'rcm', 'accounts', 'inventory', 'crm', 'integrations', 'patientPortal', 'clinicalServices', 'offerings', 'reports', 'formManagement']
};
